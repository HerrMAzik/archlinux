...
curl -L https://raw.githubusercontent.com/HerrMAzik/archlinux/master/system.sh > /home/$user_name/system.sh
chown ${user_name}:users /home/$user_name/system.sh
chmod 0700 /home/$user_name/system.sh
EOF
